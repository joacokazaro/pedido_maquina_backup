  ...
  <p>
    Titular: <b>{pedido.titular ?? "—"}</b>
      ...
      <div className="mb-4 bg-white p-3 rounded-xl border">
        <label htmlFor="supervisor-prestamo-observacion-al-entregar-opcional" className="block text-sm font-medium text-gray-700 mb-1">Observación al entregar (opcional)</label>
        <textarea id="supervisor-prestamo-observacion-al-entregar-opcional"
